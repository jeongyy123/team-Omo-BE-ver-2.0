...
export class PostsController {
  ...
  getPosts = async (req, res, next) => {
    try {
      ...
      const posts = await this.postsService.findAllPosts(page, lastSeenPage, categoryName, districtName);
  ...
  updatePost = async (req, res, next) => {
    try {
      ...
      await this.postsService.updatePost(
        userId, postId, address, content, star, storeName, placeInfoId, latitude, longitude, categoryName
      );
